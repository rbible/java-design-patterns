...
public interface IAsyncExecutor {
     ...
     */
    <T> IAsyncResult<T> startProcess(Callable<T> task);
     ...
     * @return async result for the task
     */
    <T> IAsyncResult<T> startProcess(Callable<T> task, IAsyncCallback<T> callback);
     ...
     */
    <T> T endProcess(IAsyncResult<T> asyncResult) throws ExecutionException, InterruptedException;
